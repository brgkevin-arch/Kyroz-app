...
| `PROCEDURE-2026-09-10-rejet-apple-20.md` | 🟢 **CLOSE — APPROUVÉE** (2026-09-12) | Répondre au rejet du 2026-09-10 (guidelines 4, 1.4.1 et 3.1.2(c)). **Apple a accepté le 2026-09-12**, et l'app est **en vente** : version 1.0 `READY_FOR_SALE` avec le build (22), les deux abonnements `_early` `APPROVED`. À archiver |
| `PROCEDURE-2026-09-12-fermer-acces-revue.md` | 🟢 **CLOSE** (2026-09-12) | Accès reviewer **fermé** (`anonymous_users: false`) 43 min après la publication ; fenêtre **vide**, prouvée ; **190 comptes anonymes purgés** avec (`S-03` réglé). Son **étape 3** se rejoue à CHAQUE soumission |
...
> cinq jours sans jamais y entrer. C'est exactement la panne que cette étagère a été créée
> pour fermer, rejouée sur **l'index de l'étagère elle-même** : un document qui n'est
> listé nulle part est introuvable, qu'il traîne à la racine ou dans le bon dossier.
> ➡️ **Le contrôle qui manque tient en une ligne**, à rejouer de temps en temps :
> `ls docs/procedures/*.md` et confronter au tableau. Rien ne le compte aujourd'hui.
