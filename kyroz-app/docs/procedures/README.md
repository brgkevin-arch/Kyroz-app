...
| `PROCEDURE-2026-09-10-rejet-apple-20.md` | 🟡 **CHEZ APPLE** (2026-09-10) | Répondre au rejet du 2026-09-10 (guidelines 4, 1.4.1 et 3.1.2(c)). Ses **cinq étapes sont faites** : version 1.0 en `WAITING_FOR_REVIEW` avec le build (22) depuis 19 h 58. Plus rien à faire ici — à archiver au verdict |
