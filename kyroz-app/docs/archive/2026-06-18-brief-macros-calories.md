# ARCHIVÉ — RÉSOLU · Brief « Calories & macros incohérentes »

> **Archivé le 2026-07-30.** Tous les points de ce brief sont traités depuis le
> 2026-06-18 (voir le statut détaillé plus bas). Aucun autre fichier du dépôt ne le
> référençait. ⚠️ Ses valeurs ont depuis été **remplacées** par les corrections P0/P1
> du moteur (plancher d'énergie disponible, chemin TDEE unique, NEAT paramétrable) :
> ne pas s'en servir comme référence de calcul — la vérité est dans `lib/tdee.ts`.
>
