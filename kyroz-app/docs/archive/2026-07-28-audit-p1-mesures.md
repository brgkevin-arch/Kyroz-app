# ARCHIVÉ — LIVRÉ · Audit P1, mesures (2026-07-28)

> **Archivé le 2026-07-30.** L'étape 3 qu'il arbitrait a été **livrée le 2026-07-28**
> (P1.2 MET nets, P1.1 chemin TDEE unique, NEAT paramétrable, `engine_rev`). Ce
> document reste la **trace des mesures** — en particulier le tableau NEAT, qui est la
> raison pour laquelle `desk = 1,20` est le défaut. **Ne pas le relire comme un
> reste-à-faire.**
>
