# ARCHIVÉ — LIVRÉ · Refonte recettes + adaptRecipe + soft-matching (Design)

> **Archivé le 2026-07-30.** Spec de conception de juin 2026, **entièrement livrée**
> (`lib/adaptRecipe.ts`, `lib/planEngine.ts`, 314 recettes en catalogue). Son plan
> d'exécution est archivé à côté : `2026-06-16-plan-refonte-recettes-adaptrecipe.md`.
> Conservée pour le raisonnement, pas comme reste-à-faire.
>
