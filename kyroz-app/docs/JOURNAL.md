...
> **Sorti d'`AGENTS.md` le 2026-08-30.** Il en occupait **70,5 %** (693 Ko sur 983) alors
> qu'il ne sert **jamais** à décider quoi faire : c'est de l'histoire. `AGENTS.md` est
> passé de 983 Ko à 290 Ko — autant de moins relu à chaque session.
>
> **Texte et ordre intacts.** Rien n'a été réécrit en le déplaçant.
>
> 🔴 **LES IDENTIFIANTS RESTENT UNIQUES ENTRE LES DEUX FICHIERS.** Une fiche vit sous un
> seul numéro, et ce numéro ne peut pas être repris ici parce qu'il est parti d'`AGENTS.md`.
> `lib/__tests__/agentsIds.test.ts` lit désormais **les deux fichiers ensemble** : sans ça,
> la coupure aurait scindé l'espace des numéros en deux et rouvert exactement les cinq
> collisions du 2026-08-08 que ce test avait fermées.
>
...
> Les voici, nommées une fois pour toutes (27) :
>
> `D23` · `E35` · `E36` · `E37` · `E39` · `E40` · `E41` · `E42` · `E44` · `E46` · `E47` · `E48` · `E49` · `E50` · `E51` · `E54` · `E56` · `E57` · `E58` · `E59` · `E60` · `E61` · `E62` · `E63` · `E64` · `E65` · `E66`
>
> ⚠️ **Le marqueur ne peut PAS s'écrire dans la ligne de titre.** Un premier essai y avait
> glissé `*(reclassée par mesure)*` entre le `-` et le `**` : ça rendait les 27 fiches
> **invisibles au motif de `agentsIds.test.ts`**, donc hors du contrôle des doublons. Le
> geste qui documentait le reclassement cassait le garde-fou qui le protège. Elles portent
> donc un simple `✅`, et c'est cette liste qui dit lesquelles.
>
