...
- 🤖 **E59 · Le frigo devient la RÉSERVE — et cinq règles changent ensemble (2026-08-24)**
  ...
  ⚠️ **Une différence assumée avec l'énoncé du fondateur, à re-regarder à l'usage** : il
  disait « le petit-déj à midi, le midi à 19 h ». Sur les créneaux intégrés (8 · 13 · 16 ·
  20), la règle donne 13 h · 16 h · 20 h · 23 h 59 — donc **plus tôt que ses exemples pour
  qui a une collation**. C'est la contrepartie d'une règle lue sur les créneaux réels
