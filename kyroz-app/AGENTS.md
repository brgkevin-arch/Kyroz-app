...
- ⏭️ **RESTE À FAIRE — catalogue et moteur, relevé le 2026-09-14** (à lire avant D32 → D29)
  ...
  3 septies. ✅ **D40 · Les trois défauts ouverts, corrigés — 2026-09-17** (« corrige les 3 »).
     ...
     **`ENGINE_VERSION` 57 → 58** (la sélection change). 3 fichiers de test neufs, **6
     ...
     code.*
  4. ✅ **OTA** : D32 et D33 publiés dans la 35ᵉ, D27.1 et D34 dans la 36ᵉ, D35 dans la 37ᵉ, D36 dans la 38ᵉ, D37 dans la 39ᵉ, D38 dans la 40ᵉ, D39 dans la 41ᵉ (2026-09-15), D40 dans la 42ᵉ (2026-09-17, **iOS seulement**) (ligne « OTA publiées »).
  ...
  6. 🧑 **Liste de courses « aujourd'hui → dimanche »** : décision en attente. *(La seconde
     moitié de ce point — « le plan ne se régénère pas au changement de semaine » — est
     CORRIGÉE le 2026-09-17, cf. D40 point 2.)*
