...
| Variété perçue | semaines servant 2 recettes d'un même couple : **repetitive 14,6 % · balanced 10,0 % · max 12,5 %** (22,5 / 20,0 / 20,8 % avant la vague B7 · 27,5 / 26,3 % avant A25 · 56,3 % avant D18) | `npm run mesure:variete -- --variete=…` |
| Variété perçue **par régime** | aucun 6,3 % · végétarien 12,5 % · sans gluten 2,1 % · **vegan 6,3 %** · **vegan+SG 35,4 %**. Avant B7 : vegan **41,7 %**, vegan+SG **50 %** — c'était la cible de la vague, et c'est là qu'elle a payé | `npm run mesure:variete -- --detail` |
