...
## 📍 OÙ ON EN EST — photo du 2026-08-05
...
| Tests | **1 026 verts**, 64 fichiers · `tsc` propre | `npm test && npx tsc --noEmit` |
| Design | **5 passes livrées** — 5 onglets refaits (2026-08-03) · rayons (2026-08-03) · repli du grand titre (2026-08-04) · échelle typo, 333 sites (2026-08-05) · espacement + cibles tactiles 44 pt, 537 sites (2026-08-06) · **finitions : trait, icône, retour au toucher** (2026-08-06). Maquette : `mockups/` (hors dépôt app). ⚠️ Ni le rayon ni la taille de texte ne se relisent — ils se **mesurent** | `npm test -- rayonsDA typoDA espacementDA finitionsDA` · `getComputedStyle` dans le panneau, cf. `docs/comparer-maquette.md` |
...
- **P3.4 — ⚠️ CHIFFRE RE-MESURÉ LE 2026-08-05 : ce n'est plus 3 recettes, c'est 30.** L'énoncé (« rep13/47/52 ») datait d'un catalogue de 314 recettes ; il en compte **512**, et **30 n'ont AUCUN ingrédient gras `scalable`** — donc ne peuvent pas atteindre leur cible lipides et affichent « sous la cible ». Répartition : **15 petits-déj · 11 collations · 4 repas complets** (`pd01, pd03, pd07, pd12, pd13, pd18, col02, col08, col09, col11, col18, rep13, rep47, rep52…`). Le correctif reste le même par recette (une c. à s. d'huile, des oléagineux), mais **ce n'est plus « 15 min »** — et surtout : **une entrée chiffrée qui n'est pas re-mesurée à chaque vague de catalogue devient fausse toute seule.** ➡️ Mesure : compter les recettes sans `macro_role: 'fat'` + `scalable` dans `Recette/recettes-kyroz.json`.
