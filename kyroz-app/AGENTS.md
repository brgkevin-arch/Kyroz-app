...
| 137 | Tuto : **5 → 2 bulles** (Courses, Recettes, Réserve supprimés) · Plan et Profil en **pop-up centré** · plus de « ? » de rejeu | E61 |
...
- 🤖 **E61 · Le tuto du Plan ne se jouait PAS certains jours — et il ne reste que
  ...
  📊 `tsc` propre, **1 714 tests verts, 111 fichiers**. Vérifié à l'écran : Plan et
  Profil en pop-up centré, aucun « ? » nulle part, Courses / Recettes / Réserve sans
  bulle, et surtout **le tour du Plan se joue journée entièrement cochée** — le cas qui
  ne se jouait pas.
