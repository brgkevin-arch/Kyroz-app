...
> ⚠️ Le binaire TestFlight, lui, date toujours du 3 août : ce qui est natif n'a pas bougé.
...
- ✅ **A41 · « TOUTES TES DONNÉES SERONT SUPPRIMÉES » N'ÉTAIT PAS VRAI — CORRIGÉ le
  ...
  HUMAINE EST FAITE LE MÊME JOUR** — `docs/PROCEDURE-2026-08-27-suppression-revenuecat.md`
...
- ✅ **A42 · LES QUATORZE ORPHELINS P2 — LIVRÉS le 2026-08-27.** Avec A40 et A41, les
  ...
  **Ce qui a changé une règle ou un outil**
  ...
  1. ✅ ~~`docs/PROCEDURE-2026-08-27-suppression-revenuecat.md` (A41)~~ — **FAITE le
...
- **B2 · Paywall — ✅ TOUT EST POSÉ CÔTÉ CODE ET CÔTÉ COMPTES (2026-08-25). Reste un
  ...
  **bac à sable**, puis la date. Procédure pas à pas :
  `PROCEDURE-2026-08-25-mise-en-vente-kyroz-plus.md`. L'état des produits se MESURE :
...
- 🤖 **E61 · Le tuto du Plan ne se jouait PAS certains jours — et il ne reste que
...
- 🤖 **E60 · Deux listes dans Recettes, le titre en premier, et 15 bulles de tuto en
  moins (2026-08-25)**
