...
| Tests | **1 070 verts**, 65 fichiers · `tsc` propre | `npm test && npx tsc --noEmit` |
...
silence »). Suite complète : **1 070 tests verts** (65 fichiers), `tsc` propre.
