...
| 137 | Tuto : **5 → 4 bulles** (Courses supprimé) · Plan et Profil passent en **pop-up centré**, sans anneau | E61 |
...
- 🤖 **E61 · Le tuto du Plan ne se jouait PAS certains jours — et trois bulles
  changent de forme (2026-08-25)**

  Quatre demandes du fondateur après avoir regardé les cinq bulles d'E60 tourner dans
  le navigateur. Trois sont des arbitrages de contenu ; la quatrième a fait tomber un
  défaut que personne ne cherchait.
  ...
  📊 `tsc` propre, **1 715 tests verts, 111 fichiers**. Vérifié à l'écran : Plan et
  Profil en pop-up centré, Courses sans bulle ni « ? », et surtout **le tour du Plan se
  joue maintenant journée entièrement cochée** — le cas qui ne se jouait pas.
