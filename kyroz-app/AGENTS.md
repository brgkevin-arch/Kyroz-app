...
| Tests | **1 019 verts**, 62 fichiers · `tsc` propre | `npm test && npx tsc --noEmit` |
| Design | **4 passes livrées** — 5 onglets refaits (2026-08-03) · rayons sur TOUT le reste (2026-08-03) · repli du grand titre (2026-08-04) · **échelle typo posée et migrée, 333 sites** (2026-08-05). Maquette : `mockups/` (hors dépôt app). ⚠️ Ni le rayon ni la taille de texte ne se relisent — ils se **mesurent** | `npm test -- rayonsDA typoDA` · `getComputedStyle` dans le panneau, cf. `docs/comparer-maquette.md` |
