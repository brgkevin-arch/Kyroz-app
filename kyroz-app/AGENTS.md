...
| Tests | **1 065 verts**, 64 fichiers · `tsc` propre | `npm test && npx tsc --noEmit` |
...
silence »). Suite complète : **1 065 tests verts** (64 fichiers), `tsc` propre.
