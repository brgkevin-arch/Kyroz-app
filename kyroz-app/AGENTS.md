...
| Tests | **894 verts**, 48 fichiers · `tsc` propre | `npm test && npx tsc --noEmit` |
...
| Reroll (« Régénérer mon plan ») | **78 %** des 1ers repas changent d'une régénération à l'autre (13,7 % avant A21) | `npx tsx scripts/mesure-reroll.ts` |
...
- **A11** l'app se figeait au démarrage · **A16** `Alert.alert` est une fonction VIDE sur
  ...
  **A21** « Régénérer mon plan » resservait le même plan · **A22** deux champs de
  profil hors barème, dont un qui TUAIT un écran de réglages.
