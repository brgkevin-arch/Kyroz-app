# B4 — 12 petits-déjeuners, enveloppe corrigée
...
`pd99`, `pd100`, `pd101`, `pd102`, `pd103`, `pd104`, `pd105`, `pd106`, `pd107`, `pd108`, `pd109`, `pd110`
...
| | Nombre |
|---|---|
| **Carnées ou marines** — contiennent viande, volaille ou poisson | **3** |
| **Végétariennes** — œufs et/ou laitages, **aucune** chair animale | **5** |
| **Vegan** — aucun produit animal (ni œuf, ni laitage, ni miel) | **4** |
| **dont sans gluten, toutes lignes confondues** | **≥ 6** |

Les seules ancres carnées que le §4 t'autorise sur ce créneau : `dinde_escalope` · `jambon_blanc` · `saumon_fume`. Aucune ne peut porter plus de 3 recettes (§7).
...
| 470 kcal · 28 g P | 11 / 12 |
| 517 kcal · 31 g P | 12 / 12 |
...
> **Densité protéique imposée : 5.2 à 6.5 g de protéines pour 100 kcal.**
...
| `blanc_oeuf` | Blanc d'œuf | g | 48 | 10.9 | 0.7 | 0.2 | — | — | 7 |
| `boisson_soja` | Boisson au soja nature | ml | 42 | 3.2 | 1.9 | 2.1 | — | — | 0 |
| `cacao_poudre` | Cacao maigre en poudre | g | 387 | 22.4 | 11.6 | 20.6 | — | — | 8 |
| `champignons` | Champignons | g | 21 | 2.1 | 1.8 | 0.4 | — | — | 5 |
| `chataigne` | Châtaigne | g | 189 | 2 | 36.8 | 1.8 | — | — | 4 |
| `chocolat_noir` | Chocolat noir 70% | g | 591 | 10.4 | 26.9 | 46.3 | — | ≤ 30 | 1 |
| `concombre` | Concombre | g | 17 | 0.7 | 2.9 | 0.1 | — | — | 5 |
...
| `epinards` | Épinards frais | g | 33 | 2.7 | 3.1 | 0.4 | — | — | 13 |
...
| `jambon_blanc` | Jambon blanc | g | 117 | 20.5 | 0.8 | 3.5 | — | — | 3 |
| `kiwi` | Kiwi | g | 61 | 0.9 | 11 | 0.6 | — | — | 4 |
| `lait_amande` | Lait d'amande | ml | 36 | 1.1 | 0.7 | 3.2 | — | — | 14 |
| `lait_coco` | Lait de coco | ml | 199 | 1.9 | 4.3 | 19.2 | — | ≤ 120 | 4 |
| `lait_demi_ecreme` | Lait demi-écrémé | ml | 48 | 3.5 | 5 | 1.6 | — | — | 10 |
...
| `mangue` | Mangue | g | 71 | 0.6 | 14.3 | 0.5 | — | — | 7 |
| `miel` | Miel | g | 331 | 0.7 | 82.1 | 0 | — | — | 5 |
| `millet` | Millet | g | 360 | 11 | 73 | 4 | SEC | — | 6 |
| `myrtilles` | Myrtilles | g | 58 | 0.9 | 10.6 | 0.3 | — | — | 7 |
| `noisettes` | Noisettes | g | 632 | 14.4 | 7.2 | 56.9 | — | ≤ 35 | 8 |
| `noix` | Noix | g | 709 | 13.3 | 6.9 | 67.3 | — | ≤ 35 | 7 |
| `oeuf_entier` | Œuf entier | g | 140 | 12.8 | 0.1 | 9.8 | — | — | 15 |
...
| `poivron` | Poivron | g | 23 | 0.8 | 3.5 | 0.3 | — | — | 5 |
| `polenta` | Polenta | g | 350 | 7.9 | 74 | 1.8 | SEC | — | 7 |
| `pomme` | Pomme | g | 54 | 0.2 | 11.6 | 0.2 | — | — | 11 |
| `pomme_de_terre` | Pomme de terre | g | 80 | 2 | 16.2 | 0.1 | cru | — | 2 |
| `proteine_vegetale` | Protéine végétale (pois/soja) | g | 383 | 73 | 10 | 7 | — | — | 16 |
| `quinoa` | Quinoa | g | 358 | 13.2 | 58.1 | 6.1 | SEC | — | 6 |
| `raisins` | Raisins | g | 71 | 0.7 | 16.3 | 0.2 | — | — | 1 |
| `riz_basmati` | Riz basmati | g | 351 | 7.1 | 78.4 | 0.6 | SEC | — | 3 |
| `sarrasin` | Sarrasin | g | 362 | 13.3 | 67.5 | 3.4 | SEC | — | 8 |
| `saumon_fume` | Saumon fumé | g | 184 | 22.2 | 0.1 | 10.5 | — | — | 4 |
| `sirop_erable` | Sirop d'érable | g | 269 | 0 | 67.2 | 0.1 | — | — | 4 |
| `skyr` | Skyr nature | g | 63 | 11 | 4 | 0.2 | — | — | 12 |
...
| `tomate` | Tomate | g | 18 | 0.5 | 3.4 | 0.5 | — | — | 12 |
| `tomate_concassee` | Tomate concassée | g | 23 | 1.2 | 3.6 | 0.5 | — | — | 3 |
...
| `yaourt_soja_proteine` | Yaourt de soja protéiné | g | 65 | 9 | 4 | 1.5 | — | — | 19 |
...
| `wave` | `"2026-08-02-b4-pdej-denses"` pour les 12 — c'est le nom du dossier de drop qui portera cette livraison, la convention du catalogue (`_meta.waves`). Recopie-le tel quel. |
...
Ces 17 couples portent déjà 2 recettes ou plus. Le seuil est atteint : n'en produis aucune de plus.
...
- `yaourt_soja_proteine` (protein) — déjà dans 19 recettes
- `huile_olive` (fat) — déjà dans 16 recettes
- `proteine_vegetale` (protein) — déjà dans 16 recettes
...
- `skyr` (protein) — déjà dans 12 recettes
- `beurre_cacahuete` (fat) — déjà dans 8 recettes
- `graines_courge` (fat) — déjà dans 8 recettes
- `noisettes` (fat) — déjà dans 8 recettes
- `pain_complet` (carb) — déjà dans 8 recettes
- `sarrasin` (carb) — déjà dans 8 recettes
...
| `yaourt_grec` | 2 | 1 | 18 |
| `tofu_ferme` | 4 | 1 | 18 |
| `fromage_blanc_0` | 5 | 1 | 18 |
| `cottage_cheese` | 7 | 1 | 18 |
| `whey` | 13 | 1 | 18 |
| `skyr` | 12 | 2 | 17 |
| `proteine_vegetale` | 16 | 5 | 14 |
| `yaourt_soja_proteine` | 19 | 5 | 14 |

**Refs du §4 JAMAIS employés en `petit_dej`** — terrain entièrement vierge, aucun risque de
doublon :

`boisson_soja` · `falafel` · `haricots_rouges_conserve` · `lentilles_cuites` · `pois_chiches_conserve`
...
## 8. Annexe — les 98 recettes `petit_dej` déjà au catalogue
...
Refs les plus fréquents sur ce créneau (à éviter de renforcer) : `flocons_avoine` 23 · `banane` 21 · `yaourt_soja_proteine` 19 · `huile_olive` 16 · `proteine_vegetale` 16 · `oeuf_entier` 15 · `lait_amande` 14 · `whey` 13 · `graines_chia` 13 · `epinards` 13 · `skyr` 12 · `amandes` 12 · `tomate` 12 · `pomme` 11 · `lait_demi_ecreme` 10 · `framboises` 8 · `pain_complet` 8 · `fruits_rouges` 8 · `cacao_poudre` 8 · `beurre_cacahuete` 8 · `graines_courge` 8 · `sarrasin` 8 · `noisettes` 8 · `myrtilles` 7 · `blanc_oeuf` 7 · `mangue` 7 · `cottage_cheese` 7 · `noix` 7 · `polenta` 7 · `avocat` 6 · `pain_seigle` 6 · `quinoa` 6 · `millet` 6 · `champignons` 5 · `miel` 5 · `poivron` 5 · `beurre_amande` 5 · `fromage_blanc_0` 5 · `concombre` 5 · `levure_maltee` 5 · `patate_douce` 5
...
- [ ] `wave` = `"2026-08-02-b4-pdej-denses"` sur les 12.
