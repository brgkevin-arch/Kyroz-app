...
Généré depuis le catalogue live (407 recettes) — les valeurs ci-dessous sont exactes.
...
| `avocat` | Avocat | g | 203 | 1.6 | 0 | 20.6 | — | ≤ 100 | 3 |
| `banane` | Banane | g | 88 | 1.1 | 19.7 | 0.5 | — | — | 21 |
| `beurre_amande` | Beurre d'amande | g | 631 | 21.4 | 8.8 | 52.5 | — | ≤ 40 | 4 |
...
| `cacao_poudre` | Cacao maigre en poudre | g | 387 | 22.4 | 11.6 | 20.6 | — | — | 6 |
| `champignons` | Champignons | g | 21 | 2.1 | 1.8 | 0.4 | — | — | 2 |
| `chataigne` | Châtaigne | g | 189 | 2 | 36.8 | 1.8 | — | — | 3 |
| `chocolat_noir` | Chocolat noir 70% | g | 591 | 10.4 | 26.9 | 46.3 | — | ≤ 30 | 1 |
| `concombre` | Concombre | g | 17 | 0.7 | 2.9 | 0.1 | — | — | 2 |
| `cottage_cheese` | Cottage cheese | g | 98 | 11 | 3 | 4.3 | — | — | 5 |
| `dattes` | Dattes dénoyautées | g | 287 | 1.8 | 64.7 | 0.2 | — | ≤ 60 | 3 |
| `dinde_escalope` | Escalope de dinde | g | 108 | 23.7 | 0 | 1.5 | cru | — | 1 |
| `epinards` | Épinards frais | g | 33 | 2.7 | 3.1 | 0.4 | — | — | 7 |
...
| `framboises` | Framboises | g | 48 | 1.2 | 5.8 | 0.8 | — | — | 6 |
| `fromage_blanc_0` | Fromage blanc 0% | g | 48 | 7.3 | 4.2 | 0.1 | — | — | 4 |
| `fruits_rouges` | Fruits rouges (mélange) | g | 50 | 1 | 9 | 0.4 | — | — | 8 |
| `galette_riz` | Galette de riz soufflé | g | 381 | 8.4 | 77.9 | 3 | — | — | 1 |
| `graines_chia` | Graines de chia | g | 454 | 16.5 | 7.7 | 30.7 | — | ≤ 35 | 13 |
| `graines_courge` | Graines de courge | g | 618 | 29.5 | 5.4 | 49.1 | — | ≤ 30 | 5 |
| `haricots_rouges_conserve` | Haricots rouges (conserve, égouttés) | g | 108 | 8.3 | 13 | 1 | — | — | 0 |
| `huile_olive` | Huile d'olive | g | 899 | 0.2 | 0 | 99.9 | — | ≤ 25 | 11 |
| `jambon_blanc` | Jambon blanc | g | 117 | 20.5 | 0.8 | 3.5 | — | — | 1 |
...
| `mangue` | Mangue | g | 71 | 0.6 | 14.3 | 0.5 | — | — | 6 |
| `miel` | Miel | g | 331 | 0.7 | 82.1 | 0 | — | — | 4 |
| `millet` | Millet | g | 360 | 11 | 73 | 4 | SEC | — | 5 |
| `myrtilles` | Myrtilles | g | 58 | 0.9 | 10.6 | 0.3 | — | — | 5 |
| `noisettes` | Noisettes | g | 632 | 14.4 | 7.2 | 56.9 | — | ≤ 35 | 5 |
| `noix` | Noix | g | 709 | 13.3 | 6.9 | 67.3 | — | ≤ 35 | 4 |
| `oeuf_entier` | Œuf entier | g | 140 | 12.8 | 0.1 | 9.8 | — | — | 15 |
| `pain_complet` ⛔SG | Pain complet | g | 234 | 8.7 | 41.2 | 1.7 | — | — | 7 |
| `pain_pita_complet` ⛔SG | Pain pita complet | g | 249 | 7.5 | 48.8 | 1.5 | — | — | 2 |
| `pain_sans_gluten` | Pain sans gluten | g | 249 | 4.6 | 37.1 | 6.6 | — | — | 0 |
| `pain_seigle` ⛔SG | Pain de seigle | g | 260 | 8.3 | 51.5 | 1 | — | — | 3 |
| `patate_douce` | Patate douce | g | 81 | 1.6 | 17.1 | 0.1 | cru | — | 2 |
...
| `polenta` | Polenta | g | 350 | 7.9 | 74 | 1.8 | SEC | — | 4 |
| `pomme` | Pomme | g | 54 | 0.2 | 11.6 | 0.2 | — | — | 8 |
| `pomme_de_terre` | Pomme de terre | g | 80 | 2 | 16.2 | 0.1 | cru | — | 1 |
| `proteine_vegetale` | Protéine végétale (pois/soja) | g | 383 | 73 | 10 | 7 | — | — | 13 |
| `quinoa` | Quinoa | g | 358 | 13.2 | 58.1 | 6.1 | SEC | — | 5 |
...
| `sirop_erable` | Sirop d'érable | g | 269 | 0 | 67.2 | 0.1 | — | — | 3 |
...
| `tomate` | Tomate | g | 18 | 0.5 | 3.4 | 0.5 | — | — | 5 |
| `tomate_concassee` | Tomate concassée | g | 23 | 1.2 | 3.6 | 0.5 | — | — | 1 |
...
| `oeuf_entier` | 15 | — | 19 |
| `yaourt_grec` | 2 | 1 | 18 |
| `fromage_blanc_0` | 4 | 1 | 18 |
| `tofu_ferme` | 4 | 1 | 18 |
| `whey` | 13 | 1 | 18 |
| `skyr` | 11 | 2 | 17 |
| `yaourt_soja_proteine` | 16 | 4 | 15 |
| `proteine_vegetale` | 13 | 5 | 14 |
