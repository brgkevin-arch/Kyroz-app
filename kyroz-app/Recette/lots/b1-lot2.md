...
| `wave` | `"2026-08-01-b1-lot2-repas"` pour les 20 — c'est le nom du dossier de drop qui portera cette livraison, la convention du catalogue (`_meta.waves`). Recopie-le tel quel. |
...
- [ ] `wave` = `"2026-08-01-b1-lot2-repas"` sur les 20.
