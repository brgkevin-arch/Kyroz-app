...
**Refs JAMAIS employés en `collation`** — terrain entièrement vierge, aucun risque de
doublon :

`asperges` · `betterave` · `blanc_oeuf` · `boeuf_5` · `boeuf_bavette` · `boisson_soja` · `boulgour` · `brocoli` · `cabillaud` · `champignons` · `chapelure` · `chou_fleur` · `courgette` · `creme_soja` · `crevettes` · `falafel` · `feta` · `feves` · `haricots_noirs` · `haricots_rouges` · `haricots_rouges_conserve` · `haricots_verts` · `jambon_blanc` · `legumes_wok` · `lentilles_corail` · `lentilles_cuites` · `lentilles_vertes` · `levure_maltee` · `maquereau` · `millet` · `mozzarella` · `nouilles_completes` · `nouilles_riz` · `oignon` · `olives` · `pain_sans_gluten` · `parmesan` · `patate_douce` · `pates_completes` · `pates_semoule` · `pesto` · `petits_pois` · `pois_casses` · `pois_chiches_conserve` · `poivron` · `pomme_de_terre` · `porc_filet` · `poulet_filet` · `quinoa` · `ratatouille` · `riz_basmati` · `riz_complet` · `salade_verte` · `sardines` · `saumon` · `saumon_fume` · `seitan` · `semoule_couscous` · `soja_texture` · `tempeh` · `thon_frais` · `thon_naturel` · `tofu_ferme` · `tofu_fume` · `tomate_concassee` · `tortilla_complete` · `wrap_sans_gluten` · `yaourt_soja`
...
## 8. Annexe — les 66 recettes `collation` déjà au catalogue
...
Refs les plus fréquents sur ce créneau (à éviter de renforcer) : `proteine_vegetale` 15 · `flocons_avoine` 13 · `banane` 13 · `beurre_cacahuete` 12 · `yaourt_soja_proteine` 12 · `lait_amande` 9 · `graines_chia` 9 · `galette_riz` 9 · `miel` 8 · `whey` 8 · `huile_olive` 8 · `amandes` 7 · `cottage_cheese` 7 · `dattes` 7 · `cacao_poudre` 7 · `skyr` 6 · `lait_demi_ecreme` 5 · `concombre` 5 · `graines_courge` 5

| id | ensemble de refs |
|---|---|
| col01 | `skyr` · `flocons_avoine` · `amandes` · `miel` |
| col02 | `whey` · `banane` · `lait_demi_ecreme` |
| col03 | `cottage_cheese` · `ananas` · `noix` |
| col04 | `dattes` · `flocons_avoine` · `beurre_cacahuete` · `cacao_poudre` · `proteine_vegetale` |
| col05 | `pain_complet` · `beurre_cacahuete` · `banane` |
| col06 | `proteine_vegetale` · `banane` · `beurre_cacahuete` · `lait_amande` · `dattes` · `flocons_avoine` |
...
| col10 | `amandes` · `chocolat_noir` · `pomme` |
...
| col15 | `flocons_avoine` · `whey` · `miel` · `beurre_cacahuete` · `lait_demi_ecreme` |
| col16 | `edamame` · `sauce_soja` |
| col17 | `yaourt_grec` · `raisins` · `noisettes` · `flocons_avoine` |
...
| col25 | `skyr` · `ananas` · `epinards` · `graines_chia` |
...
| col30 | `yaourt_grec` · `miel` · `noisettes` |
| col31 | `dattes` · `beurre_cacahuete` · `flocons_avoine` · `proteine_vegetale` |
| col32 | `flocons_avoine` · `proteine_vegetale` · `chocolat_noir` · `amandes` · `dattes` |
| col33 | `graines_chia` · `dattes` · `proteine_vegetale` · `cacao_poudre` · `flocons_avoine` |
...
| col41 | `pois_chiches` · `huile_olive` |
| col42 | `yaourt_grec` · `flocons_avoine` · `framboises` · `amandes` |
...
| col64 | `haricots_blancs` · `tahini` · `huile_olive` · `carotte` |
| col65 | `edamame` · `concombre` · `tomate` · `huile_olive` |
| col66 | `tofu_soyeux` · `proteine_vegetale` · `framboises` |
