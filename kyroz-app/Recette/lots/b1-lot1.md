...
`rep171`, `rep172`, `rep173`, `rep174`, `rep175`, `rep176`, `rep177`, `rep178`, `rep179`, `rep180`, `rep181`, `rep182`, `rep183`, `rep184`, `rep185`, `rep186`, `rep187`, `rep188`, `rep189`, `rep190`
...
- ⚠️ **Ce lot est le n° 1 sur 4, tous à la même enveloppe.** C'est le risque de doublon le plus élevé de la vague. Tu ouvres la série : varie les ancres dès maintenant, ne pose pas trois plats au poulet.
...
| `wave` | `"2026-08-01-b1-lot1-repas"` pour les 20 — c'est le nom du dossier de drop qui portera cette livraison, la convention du catalogue (`_meta.waves`). Recopie-le tel quel. |
...
- [ ] `wave` = `"2026-08-01-b1-lot1-repas"` sur les 20.
