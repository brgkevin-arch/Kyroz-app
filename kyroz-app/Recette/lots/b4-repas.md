# B4 — 20 repas complets, enveloppe corrigée
...
Généré depuis le catalogue live (427 recettes) — les valeurs ci-dessous sont exactes.
...
`rep251`, `rep252`, `rep253`, `rep254`, `rep255`, `rep256`, `rep257`, `rep258`, `rep259`, `rep260`, `rep261`, `rep262`, `rep263`, `rep264`, `rep265`, `rep266`, `rep267`, `rep268`, `rep269`, `rep270`
...
| | Nombre |
|---|---|
| **Carnées ou marines** — contiennent viande, volaille ou poisson | **12** |
| **Végétariennes** — œufs et/ou laitages, **aucune** chair animale | **4** |
| **Vegan** — aucun produit animal (ni œuf, ni laitage, ni miel) | **4** |
...
| 676 kcal · 42 g P | 12 / 12 | ← l'enveloppe de CE lot
...
> **Densité protéique imposée : 5.4 à 7.1 g de protéines pour 100 kcal.**
...
| `asperges` | Asperges | g | 25 | 2.5 | 2 | 0.3 | — | — | 8 |
| `avocat` | Avocat | g | 203 | 1.6 | 0 | 20.6 | — | ≤ 100 | 21 |
| `betterave` | Betterave cuite | g | 42 | 1.4 | 7.1 | 0.4 | — | — | 5 |
| `beurre_cacahuete` | Beurre de cacahuète | g | 643 | 22.2 | 17.3 | 51.4 | — | ≤ 40 | 8 |
| `blanc_oeuf` | Blanc d'œuf | g | 48 | 10.9 | 0.7 | 0.2 | — | — | 10 |
| `boeuf_5` | Bœuf haché 5% MG | g | 130 | 21.9 | 0.3 | 4.6 | cru | — | 14 |
| `boeuf_bavette` | Bavette de bœuf | g | 133 | 20.4 | 0 | 5.7 | cru | — | 8 |
| `boisson_soja` | Boisson au soja nature | ml | 42 | 3.2 | 1.9 | 2.1 | — | — | 0 |
| `boulgour` ⛔SG | Boulgour | g | 347 | 11.7 | 65.8 | 1.4 | SEC | — | 18 |
| `brocoli` | Brocoli | g | 32 | 2.9 | 2.1 | 0.4 | — | — | 21 |
| `cabillaud` | Dos de cabillaud | g | 77 | 18.1 | 0 | 0.6 | cru | — | 16 |
| `carotte` | Carotte | g | 30 | 0.8 | 5.2 | 0.5 | — | — | 17 |
| `champignons` | Champignons | g | 21 | 2.1 | 1.8 | 0.4 | — | — | 18 |
| `chapelure` ⛔SG | Chapelure | g | 365 | 9.4 | 74.3 | 1.6 | — | ≤ 40 | 1 |
| `chou_fleur` | Chou-fleur | g | 25 | 1.8 | 2.1 | 0.7 | — | — | 8 |
| `concombre` | Concombre | g | 17 | 0.7 | 2.9 | 0.1 | — | — | 13 |
| `cottage_cheese` | Cottage cheese | g | 98 | 11 | 3 | 4.3 | — | — | 7 |
| `courgette` | Courgette | g | 17 | 1.2 | 1.8 | 0.3 | — | — | 27 |
| `creme_soja` | Crème de soja | ml | 152 | 3.2 | 2 | 14.7 | — | ≤ 80 | 11 |
| `crevettes` | Crevettes cuites | g | 91 | 20.5 | 0.2 | 0.8 | — | — | 10 |
| `dinde_escalope` | Escalope de dinde | g | 108 | 23.7 | 0 | 1.5 | cru | — | 11 |
| `edamame` | Edamame | g | 125 | 11 | 9 | 5 | — | — | 5 |
| `epinards` | Épinards frais | g | 33 | 2.7 | 3.1 | 0.4 | — | — | 30 |
...
| `fromage_blanc_0` | Fromage blanc 0% | g | 48 | 7.3 | 4.2 | 0.1 | — | — | 5 |
...
| `huile_olive` | Huile d'olive | g | 899 | 0.2 | 0 | 99.9 | — | ≤ 25 | 133 |
| `jambon_blanc` | Jambon blanc | g | 117 | 20.5 | 0.8 | 3.5 | — | — | 8 |
| `lait_coco` | Lait de coco | ml | 199 | 1.9 | 4.3 | 19.2 | — | ≤ 120 | 25 |
| `legumes_wok` | Mélange wok (poivron/brocoli/carotte) | g | 30 | 1.5 | 5 | 0.3 | — | — | 14 |
...
| `millet` | Millet | g | 360 | 11 | 73 | 4 | SEC | — | 11 |
| `mozzarella` | Mozzarella light | g | 227 | 16.5 | 0.7 | 17.7 | — | ≤ 60 | 3 |
| `nouilles_completes` ⛔SG | Nouilles complètes | g | 353 | 11.8 | 67.6 | 2.2 | SEC | — | 4 |
| `nouilles_riz` | Nouilles de riz | g | 365 | 7.4 | 80.5 | 1 | SEC | — | 12 |
| `oeuf_entier` | Œuf entier | g | 140 | 12.8 | 0.1 | 9.8 | — | — | 20 |
| `oignon` | Oignon | g | 39 | 1.1 | 6.2 | 0.6 | — | — | 24 |
| `olives` | Olives | g | 182 | 1.4 | 0.3 | 18 | — | ≤ 40 | 9 |
...
| `parmesan` | Parmesan | g | 411 | 31.1 | 1.1 | 31 | — | ≤ 40 | 8 |
| `patate_douce` | Patate douce | g | 81 | 1.6 | 17.1 | 0.1 | cru | — | 21 |
| `pates_completes` ⛔SG | Pâtes complètes | g | 353 | 11.8 | 67.6 | 2.2 | SEC | — | 17 |
| `pates_semoule` ⛔SG | Pâtes (semoule) | g | 364 | 12 | 72.7 | 1.6 | SEC | — | 7 |
| `pesto` | Pesto | g | 370 | 3.9 | 6.6 | 35.4 | — | ≤ 30 | 6 |
| `petits_pois` | Petits pois | g | 92 | 4.9 | 13.7 | 0.8 | — | — | 8 |
...
| `poivron` | Poivron | g | 23 | 0.8 | 3.5 | 0.3 | — | — | 28 |
| `polenta` | Polenta | g | 350 | 7.9 | 74 | 1.8 | SEC | — | 16 |
| `pomme_de_terre` | Pomme de terre | g | 80 | 2 | 16.2 | 0.1 | cru | — | 18 |
| `poulet_filet` | Filet de poulet | g | 110 | 23.4 | 0 | 1.5 | cru | — | 35 |
| `proteine_vegetale` | Protéine végétale (pois/soja) | g | 383 | 73 | 10 | 7 | — | — | 0 |
| `quinoa` | Quinoa | g | 358 | 13.2 | 58.1 | 6.1 | SEC | — | 22 |
| `ratatouille` | Ratatouille de légumes | g | 35 | 1.2 | 5 | 1 | — | — | 12 |
| `riz_basmati` | Riz basmati | g | 351 | 7.1 | 78.4 | 0.6 | SEC | — | 31 |
| `riz_complet` | Riz complet | g | 350 | 7 | 71.4 | 2.8 | SEC | — | 21 |
| `roquette` | Roquette | g | 28 | 2.6 | 2.1 | 0.7 | — | — | 19 |
| `salade_verte` | Salade verte | g | 14 | 1 | 1.5 | 0.1 | — | — | 14 |
| `sardines` | Sardines (conserve égouttées) | g | 217 | 23.3 | 0.3 | 13.7 | — | — | 5 |
| `sarrasin` | Sarrasin | g | 362 | 13.3 | 67.5 | 3.4 | SEC | — | 14 |
...
| `seitan` ⛔SG | Seitan | g | 134 | 20.6 | 6.7 | 2.5 | — | — | 11 |
| `semoule_couscous` ⛔SG | Semoule de couscous | g | 350 | 11.8 | 69.8 | 1.3 | SEC | — | 12 |
| `soja_texture` | Protéine de soja texturée (PST) | g | 345 | 52 | 30 | 1 | SEC | ≤ 70 | 37 |
| `tahini` | Purée de sésame (tahini) | g | 631 | 17.7 | 13.8 | 53.4 | — | ≤ 40 | 9 |
| `tempeh` | Tempeh | g | 157 | 16.1 | 7.9 | 4.7 | — | — | 7 |
| `thon_frais` | Thon frais | g | 155 | 24 | 2.7 | 5.4 | cru | — | 5 |
| `thon_naturel` | Thon au naturel (conserve) | g | 143 | 26.8 | 0 | 3.9 | — | — | 13 |
...
| `tomate` | Tomate | g | 18 | 0.5 | 3.4 | 0.5 | — | — | 28 |
| `tomate_concassee` | Tomate concassée | g | 23 | 1.2 | 3.6 | 0.5 | — | — | 37 |
...
| `wave` | `"2026-08-02-b4-repas-denses"` pour les 20 — c'est le nom du dossier de drop qui portera cette livraison, la convention du catalogue (`_meta.waves`). Recopie-le tel quel. |
...
Ces 30 couples portent déjà 2 recettes ou plus. Le seuil est atteint : n'en produis aucune de plus.
...
| cottage_cheese × millet | 2 | rep222, rep242 |
...
- `huile_olive` (fat) — déjà dans 133 recettes
- `soja_texture` (protein) — déjà dans 37 recettes
- `poulet_filet` (protein) — déjà dans 35 recettes
- `riz_basmati` (carb) — déjà dans 31 recettes
- `lait_coco` (fat) — déjà dans 25 recettes
- `quinoa` (carb) — déjà dans 22 recettes
- `avocat` (fat) — déjà dans 21 recettes
- `patate_douce` (carb) — déjà dans 21 recettes
- `riz_complet` (carb) — déjà dans 21 recettes
- `oeuf_entier` (protein) — déjà dans 20 recettes
- `boulgour` (carb) — déjà dans 18 recettes
- `pomme_de_terre` (carb) — déjà dans 18 recettes
- `pates_completes` (carb) — déjà dans 17 recettes
- `pois_chiches` (protein) — déjà dans 17 recettes
- `tofu_ferme` (protein) — déjà dans 17 recettes
...
`boisson_soja` · `falafel` · `haricots_rouges_conserve` · `lentilles_cuites` · `pois_chiches_conserve` · `proteine_vegetale` · `tofu_fume`
...
## 8. Annexe — les 250 recettes `repas_complet` déjà au catalogue
...
Refs les plus fréquents sur ce créneau (à éviter de renforcer) : `huile_olive` 133 · `tomate_concassee` 37 · `soja_texture` 37 · `poulet_filet` 35 · `riz_basmati` 31 · `epinards` 30 · `poivron` 28 · `tomate` 28 · `courgette` 27 · `lait_coco` 25 · `oignon` 24 · `quinoa` 22 · `brocoli` 21 · `patate_douce` 21 · `riz_complet` 21 · `avocat` 21 · `oeuf_entier` 20 · `roquette` 19 · `boulgour` 18 · `pomme_de_terre` 18 · `champignons` 18 · `tofu_ferme` 17 · `pois_chiches` 17 · `pates_completes` 17 · `carotte` 17 · `cabillaud` 16 · `polenta` 16 · `graines_courge` 15 · `saumon` 14 · `boeuf_5` 14 · `legumes_wok` 14 · `salade_verte` 14 · `sarrasin` 14 · `sauce_soja` 13 · `thon_naturel` 13 · `concombre` 13 · `haricots_verts` 12 · `mais` 12 · `nouilles_riz` 12 · `ratatouille` 12 · `feta` 12 · `semoule_couscous` 12 · `dinde_escalope` 11 · `seitan` 11 · `creme_soja` 11 · `millet` 11 · `crevettes` 10 · `amandes` 10 · `blanc_oeuf` 10 · `haricots_rouges` 9 · `olives` 9 · `tahini` 9 · `boeuf_bavette` 8 · `asperges` 8 · `pain_complet` 8 · `beurre_cacahuete` 8 · `chou_fleur` 8 · `parmesan` 8 · `petits_pois` 8 · `jambon_blanc` 8 · `tortilla_complete` 7 · `cottage_cheese` 7 · `tempeh` 7 · `pates_semoule` 7 · `pesto` 6 · `lentilles_corail` 5 · `betterave` 5 · `edamame` 5 · `thon_frais` 5 · `sardines` 5 · `haricots_noirs` 5 · `haricots_blancs` 5 · `fromage_blanc_0` 5
...
- [ ] `wave` = `"2026-08-02-b4-repas-denses"` sur les 20.
