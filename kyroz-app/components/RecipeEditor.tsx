...
function makeStyles(t: ThemePalette) {
  return StyleSheet.create({
    ...
    suggestRow: { paddingHorizontal: Spacing.md, paddingVertical: Spacing.md, minHeight: CIBLE_TACTILE_MIN, justifyContent: 'center', borderBottomWidth: Trait.fin, borderBottomColor: t.line, backgroundColor: t.scheme === 'dark' ? t.fill : t.card },
    ...
    footer: { padding: Spacing.xxl, paddingTop: Spacing.md, borderTopWidth: Trait.fin, borderTopColor: t.line, gap: Spacing.sm },
