            ...
            <>
              ...
              <Presse style={s.consent} onPress={() => setConsent((c) => !c)} activeOpacity={OPACITE_PRESSION}>
                ...
                <Text style={s.consentTxt}>
                  J'accepte que mes données (poids, taille, composition corporelle, objectif, régime), qui sont des <Text style={{ fontWeight: '700', color: t.textSecondary }}>données de santé</Text>, soient traitées pour générer mes plans. Stockage en Europe, supprimables à tout moment.
                </Text>
              </Presse>
