...
export const PROTEIN_REFS: Record<string, string[]> = {
  ...
  'végétal': [
    ...
    'filets_poulet_vegetal', 'aiguillettes_poulet_vegetal', 'chorizo_vegetal',
  ],
};
