...
export const PROTEIN_REFS: Record<string, string[]> = {
  ...
  'végétal': [
    ...
    'galette_vegetale', 'boulette_vegetale', 'nuggets_vegetal', 'saucisse_vegetale',
  ],
};
