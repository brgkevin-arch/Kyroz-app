...
- [ ] 🔴 **LES TROIS VERROUS DE LA CLÉ POSTHOG.** `EXPO_PUBLIC_POSTHOG_KEY` ne se pose pas
  ...
  - [x] **Couper la collecte d'IP** — **déjà fait, vérifié le 2026-08-19.** Les projets
